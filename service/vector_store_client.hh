...
struct vector_store_client_tester {
    ...
    static void set_dns_resolver(vector_store_client& vsc, std::function<future<net::inet_address>(sstring const&)> resolver);
    static void trigger_dns_resolver(vector_store_client& vsc);
    static auto can_resolve_hostname(vector_store_client& vsc) -> future<bool>;
};
